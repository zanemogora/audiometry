   ...
   /* back_btn.addEventListener('click', function() {
    ...
    playbtn.addEventListener('click', function() {
       if (computerChoice == 'auto_auticko_sound') {
            var audio = new Audio('audio_lave_ucho/2c_auto_auticko.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'ruka_sound') {
            var audio = new Audio('audio_lave_ucho/42b_ruka.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'chlieb_chlebik_sound') {
            var audio = new Audio('audio_lave_ucho/48_chlieb_chlebik.wav');
            audio.play();
            playFunc(audio, 1);
       }
