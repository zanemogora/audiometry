   ...
   /* back_btn.addEventListener('click', function() {
    ...
    play_btn.addEventListener('click', function() {
       if (computerChoice == 'babika_place_sound') {
            var audio = new Audio('audio_lave_ucho/25_babika place.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'babika_sound') {
            var audio = new Audio('audio_lave_ucho/34_babika.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'babika_spi_sound') {
            var audio = new Audio('audio_lave_ucho/24_babika spi.wav');
            audio.play();
            playFunc(audio, 1);
       }
