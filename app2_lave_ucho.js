...
play_btn.addEventListener('click', function() {
       ...
       if (computerChoice == 'macka_a_pes_sound') {
            var audio = new Audio('audio_lave_ucho/30_macka a pes.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'macka_a_konik_sound') {
            var audio = new Audio('audio_lave_ucho/32_macka a konik.wav');
            audio.play();
            playFunc(audio, 1);
       }

       if (computerChoice == 'macka_macicka_sound') {
            var audio = new Audio('audio_lave_ucho/10_macka_macicka.wav');
            audio.play();
            playFunc(audio, 1);
       }
})
